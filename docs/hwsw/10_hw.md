...
!!! warning "Completa le conoscenze"
    ...
    * Che differenza c'è fra un processore e un controllore?
    * Come si determinano le prestazioni di una CPU?
    * Come si calcola la sua velocità?
    * Hai mai fatto un benchmark della tua CPU??? Vogliamo organizzarne uno... di classe?
