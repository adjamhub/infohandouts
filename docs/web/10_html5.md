...
- PHP, un linguaggio di programmazione web lato server
...
Sta per Hyper Textual Markup Language.

Siamo alla versione 5.x

Utilizza documenti di testo semplice, con estensione .html

Si basa sui TAG, che funzionano come le parentesi (apri tag, scrivi,
chiudi tag).
